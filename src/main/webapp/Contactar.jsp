...
<body>
					...
					<ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll"
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="ControladorLoginInicioS">Localiza
										tu envío</a></li>
								...
								<li><a class="dropdown-item" href="#">Nuestras
										sucursales</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="#">Envíos al
										extranjero</a></li>
								...
								style="color: white; text-decoration: none;">
									...
									<button type="button" class="btn btn-outline-light">
										<i class="fa-solid fa-user"
											style="color: #FFFFFF; margin-right: 5px"></i> Iniciar Sesión
									</button>
	...
	<header
		style="background-image: url(img/fondo3.jpg); background-size: cover; background-position: bottom; height: 400px;">
				...
				<div class="row">
					...
					<div class="segunda-columna col-12 col-md-6">
						<div>
							...
							<div>
								<p>Enviando un mensaje obtendrás respuesta casi inmediata en
									un rango menor a 24h desde el envío del mensaje.</p>
							</div>
						</div>
	...
	<section class="seccion-mapa">
		<div>
			...
			<iframe
				src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2901.493067978924!2d-1.7999994230496092!3d43.34579587111836!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd5108574109200f%3A0x76e7a4caa007390f!2sIES%20Plaiaundi%20BHI!5e0!3m2!1ses!2ses!4v1683640712888!5m2!1ses!2ses"
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingOne">
								<button class="accordion-button collapsed" type="button"
									...
									¿Cómo puedo realizar un envío?</button>
							</h2>
							<div id="flush-collapseOne" class="accordion-collapse collapse"
								aria-labelledby="flush-headingOne"
								data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">Para realizar un envío tienes
									que acercarte a la sucursal más cercana con los datos del
									destinatario.</div>
							</div>
						</div>
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingTwo">
								<button class="accordion-button collapsed" type="button"
									...
									¿Cuáles son los datos del destinatario?</button>
							</h2>
							<div id="flush-collapseTwo" class="accordion-collapse collapse"
								aria-labelledby="flush-headingTwo"
								data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">Para realizar un envío de
									forma correcta, necesitaremos el dni y la dirección del
									destinatario.</div>
							</div>
						</div>
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingThree">
								<button class="accordion-button collapsed" type="button"
									...
									¿Cuánto tarda en llegar mi envío?</button>
							</h2>
							<div id="flush-collapseThree" class="accordion-collapse collapse"
								aria-labelledby="flush-headingThree"
								data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">
									Dependiendo de la distancia, tardamos entre 24 y 72 horas.
									Puedes obtener más detalles de tu envío iniciando sesión <a
										href="ControladorLoginInicioS">aquí.</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col-12 col-md-4">
				...
				<ul>
					...
					<li><p>
							<strong><a href="#">Tarifas de envíos > </a></strong>
						</p></li>

					<li><p>
							<strong><a href="#">Métodos de pago > </a></strong>
						</p></li>

					<li><p>
							<strong><a href="#">Encuéntranos > </a></strong>
						</p></li>

					<li><p>
							<strong><a href="ControladorLoginEmpleados">Sección
									empleados > </a></strong>
						</p></li>
