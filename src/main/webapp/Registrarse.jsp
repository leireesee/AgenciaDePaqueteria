...
<body>
					...
					<ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll"
						...
						<li style="margin-left: 100px;">
							<div
								...
								<i class="fa-solid fa-user" style="color: #FFFFFF"></i> Iniciar
								Sesión
							</div>
						</li>
						<li style="margin-left: 10px;">
							<div
								style="background-color: #004E86; padding: 7px; border-radius: 5px; color: white;">
	...
	<section
		...
		<div
			style="box-shadow: 0px 0px 10px rgb(127, 140, 255); padding: 30px;">
			<h2>Registrarme</h2>
			<br>
			<form method="post" action="ControladorRegistrarse"
			...
			<br>
			<p class="text-center">
				Ya tienes una cuenta? <a data-toggle="tab"
					href="ControladorLoginInicioS">Iniciar Sesión</a>
			</p>
		</div>
	</section>
