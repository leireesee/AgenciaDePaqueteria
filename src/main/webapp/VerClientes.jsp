...
<body>
    <section id="clientes">
    			...
    			<h1>VER CLIENTES</h1>
    			<button type="button" class="btn btn-primary"><a href="ControladorVistaEmpleado" style="color: white">VOLVER</a></h1></button>
			...
			<c:forEach items="${clientes}" var="cliente">
				...
				<tr>
					...
					<th><button type="button" class="btn btn-danger"><a href=ControladorClienteEliminar?codCliente=${cliente.codCliente} style="color: white !important">DAR DE BAJA </a></button></th>
