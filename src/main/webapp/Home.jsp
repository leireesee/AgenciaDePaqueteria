...
<body>
							...
							<ul class="dropdown-menu">
								...
								<c:if test="${sessionScope.cliente.dniCif!=null}">
									<li><a class="dropdown-item"
										href="ControladorVistaCliente">Localiza tu envío</a></li>
									<li>
								</c:if>

								<c:if test="${sessionScope.cliente.dniCif==null}">
									<li><a class="dropdown-item"
										href="ControladorLoginInicioS">Localiza tu envío</a></li>
									<li>
								</c:if>
						...
						<c:if test="${sessionScope.cliente.codCliente!=null}">
							...
							<li style="list-style-type: none">
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item"
											href="ControladorVistaCliente">Ver mis envíos</a></li>
										<li><a class="dropdown-item"
	...
	<header
		...
		<div class="texto-header">
			...
			<h1>
				<span>Rápidos y Confiables</span>
			</h1>



			<p class="info">Envía y recibe envíos en tan solo 5 minutos a
		...
		<div class="cards-display">
			...
			<div class="card" style="width: 25rem;">
				...
				<div class="card-body">
					...
					<p class="card-text">Para realizar un envío tan solo necesitas
			...
			<div class="card" style="width: 25rem;">
				...
				<div class="card-body">
					...
					<p class="card-text">Podrás ver en todo momento donde se
						encuentra tu envío gracias a nuestro tracking.</p>

					<a href="#"> <a href="ControladorLoginInicioS"><button
								type="button" class="btn btn-warning">Localiza tu envío</button></a>
			...
			<div class="card" style="width: 25rem;">
				...
				<div class="card-body">
					...
					<p class="card-text">Para recoger un envío debes de ser la
			...
			<ul>
				...
				<li>
					...
					<article>
						...
						<p>Con la ayuda de nuestro servicio express, cuidarás de ti o
							de tu negocio.</p>
				...
				<li>
					...
					<article>
						...
						<p>Nuestro sistema de tracking te permitirá saber donde se
				...
				<li>
					...
					<article>
						...
						<p>Contamos con una atención al cliente que se adapta a tus
				...
				<li>
					...
					<article>
						...
						<p>Contamos con envíos internacionales que te permitirán
