...
<body>
 ...
 <header style="background-image: url(img/fondo3.jpg); background-size: cover; background-position: bottom;">
 ...
 <p style="margin-top: 60px; text-align: center"><img alt="" src="img/camion.png" width="650px"></p>
 ...
 <p class="card-text">Para realizar un envío tan solo necesitas DNI y seleccionar tu tarifa adecuada.</p>

 <a href="#">

 <button type="button" class="btn btn-warning">Consultar tarifas</button>
 ...
 <button type="button" class="btn btn-warning">Tarifas de cobro a destinatario</button>
 ...
 <h2>Ventajas de <img src="img/logo.svg" alt="" width="250px"></h2>
