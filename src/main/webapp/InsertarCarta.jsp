...
<body
	...
	<section
		...
		<div
			...
			<br>
			<form method="post" action="ControladorCarta" class="signin-form"
				style="width: 400px;">




				<label class="label" for="password">Desea enviarlo
					mensualmente?</label> <br> <br> <select class="form-select"
					aria-label="Default select example" name="mensual">
